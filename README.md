...
![NPM version](https://img.shields.io/npm/v/@kevinangkajaya/react-sortable-tree.svg?style=flat)
![NPM license](https://img.shields.io/npm/l/@kevinangkajaya/react-sortable-tree.svg?style=flat)
[![NPM total downloads](https://img.shields.io/npm/dt/@kevinangkajaya/react-sortable-tree.svg?style=flat)](https://npmcharts.com/compare/@kevinangkajaya/react-sortable-tree?minimal=true)
[![NPM monthly downloads](https://img.shields.io/npm/dm/@kevinangkajaya/react-sortable-tree.svg?style=flat)](https://npmcharts.com/compare/@kevinangkajaya/react-sortable-tree?minimal=true)
...
```sh
# NPM
npm install @kevinangkajaya/react-sortable-tree --save

# YARN
yarn add @kevinangkajaya/react-sortable-tree
```
...
import '@kevinangkajaya/react-sortable-tree/style.css';

// You can import the default tree with dnd context
import SortableTree from '@kevinangkajaya/react-sortable-tree';

// Or you can import the tree without the dnd context as a named export. eg
import { SortableTreeWithoutDndContext as SortableTree } from '@kevinangkajaya/react-sortable-tree';

// Importing from cjs (default)
import SortableTree from '@kevinangkajaya/react-sortable-tree/dist/index.cjs.js';
import SortableTree from '@kevinangkajaya/react-sortable-tree';

// Importing from esm
import SortableTree from '@kevinangkajaya/react-sortable-tree/dist/index.esm.js';
```
...
import SortableTree from '@kevinangkajaya/react-sortable-tree';
import '@kevinangkajaya/react-sortable-tree/style.css'; // This only needs to be imported once in your app
...
Check out the helper functions exported from [`tree-data-utils.js`](https://github.com/kevinangkajaya/react-sortable-tree/blob/master/src/utils/tree-data-utils.js).
